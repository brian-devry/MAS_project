...
#think we need to bypass this for now# import RPi.GPIO as GPIO
import time

# setup gpio pins (commented out for testing)
# GPIO.cleanup()
...
while loop == "1":
    ...
    # test GPIO for input on pin 17 (commented out for testing)
